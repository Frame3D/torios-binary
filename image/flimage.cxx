...
Fl_Double_Window* UserInterface::make_window() {
  { Fl_Double_Window* o = win = new Fl_Double_Window(385, 375, "Image Viewer");
    ...
    { Fl_Button* o = new Fl_Button(325, 27, 25, 25, "@<");
      o->tooltip("Press \',\' to use this");
      o->box(FL_FLAT_BOX);
      o->shortcut(0x2c);
      o->color((Fl_Color)23);
      o->callback((Fl_Callback*)cb_);
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(355, 27, 25, 25, "@>");
      o->tooltip("Press \'.\' to use this");
      o->box(FL_FLAT_BOX);
      o->shortcut(0x2e);
      o->color((Fl_Color)23);
