...
Fl_Double_Window* UI::make_window() {
  { passwin = new Fl_Double_Window(240, 120, "ToriOS Askpass");
    passwin->user_data((void*)(this));
    { Fl_Input* o = password = new Fl_Input(25, 30, 200, 35, "Password");
      password->type(5);
      password->box(FL_FLAT_BOX);
      password->align(Fl_Align(257));
      o->copy_label(MSG.c_str());
    } // Fl_Input* password
    { Fl_Button* o = new Fl_Button(60, 75, 80, 35, "Cancel");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
    ...
    { ok = new Fl_Button(150, 75, 75, 35, "Ok");
      ok->box(FL_FLAT_BOX);
