...
Fl_Double_Window* UI::install_list_window() {
  { install_win = new Fl_Double_Window(270, 295, "Install");
    ...
    { Fl_Button* o = new Fl_Button(130, 260, 65, 30, "Close");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
    ...
    { Fl_Button* o = new Fl_Button(200, 260, 65, 30, "Install");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)61);
    ...
    { Fl_Button* o = new Fl_Button(5, 260, 95, 30, "Information");
      o->box(FL_FLAT_BOX);
...
Fl_Double_Window* UI::make_window() {
  { about = new Fl_Double_Window(345, 345, "Welcome");
    about->user_data((void*)(this));
    { Fl_Button* o = new Fl_Button(265, 300, 65, 30, "Exit");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
      o->selection_color(FL_DARK_RED);
      o->labelcolor(FL_BACKGROUND2_COLOR);
    ...
    { Fl_Group* o = new Fl_Group(5, 30, 255, 125, "Install");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)46);
      o->labelsize(20);
      { Fl_Button* o = new Fl_Button(10, 35, 120, 35, "Web Browser");
        o->tooltip("Install many popular web browsers");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Web);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(135, 35, 120, 35, "Office Programs");
        o->tooltip("Write documents easily");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Office);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(10, 75, 120, 35, "Music Player");
        o->tooltip("Install a music player");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Music);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(10, 115, 120, 35, "Video Player");
        o->tooltip("Install a video player");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Video);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(135, 75, 120, 35, "Media Codecs");
        o->tooltip("Install programs needed to play certain media");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Media);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(135, 115, 120, 35, "Games");
        o->tooltip("Many games to choose from");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
    ...
    { Fl_Group* o = new Fl_Group(5, 180, 255, 45, "Update");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)46);
      o->labelsize(20);
      { Fl_Button* o = new Fl_Button(10, 185, 120, 35, "System");
        o->tooltip("Keep your system up to date");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_System);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(135, 185, 120, 35, "Bootloader");
        o->tooltip("Update your computers boot loader");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
    ...
    { Fl_Group* o = new Fl_Group(5, 250, 255, 85, "System");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)46);
      o->labelsize(20);
      { Fl_Button* o = new Fl_Button(10, 255, 120, 35, "Appearance");
        o->tooltip("Configure your desktop");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Appearance);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(135, 255, 120, 35, "Login");
        o->tooltip("Modify user logins easily");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->callback((Fl_Callback*)cb_Login);
        if(!test_exec("fltk-lightdm"))o->deactivate();
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(10, 295, 120, 35, "Information");
        o->tooltip("Get information on your computer");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->deactivate();
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(135, 295, 120, 35, "Language");
        o->tooltip("Modify language settings");
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->deactivate();
      } // Fl_Button* o
    ...
    { Fl_Button* o = new Fl_Button(265, 35, 65, 40, "ToriOS Website");
      o->tooltip("See our website");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)61);
      o->selection_color(FL_DARK_GREEN);
      o->labelcolor(FL_BACKGROUND2_COLOR);
    ...
    { Fl_Button* o = new Fl_Button(265, 80, 65, 40, "ToriOS Code");
      o->tooltip("Code with us!");
      o->box(FL_FLAT_BOX);
      o->color(FL_YELLOW);
    ...
    { Fl_Button* o = new Fl_Button(265, 125, 65, 40, "ToriOS Twitter");
      o->tooltip("Tweet us!");
      o->box(FL_FLAT_BOX);
...
Fl_Double_Window* UI::info_window(std::string MSG) {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(270, 260);
    ...
    { Fl_Button* o = new Fl_Button(200, 225, 65, 30, "Close");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
      o->selection_color(FL_DARK_RED);
      o->labelcolor(FL_BACKGROUND2_COLOR);
...
Fl_Double_Window* UI::make_terminal() {
  { term_win = new Fl_Double_Window(320, 275, "Terminal Output");
    term_win->user_data((void*)(this));
    { Fl_Button* o = new Fl_Button(240, 235, 65, 30, "Close");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
      o->selection_color(FL_DARK_RED);
      o->labelcolor(FL_BACKGROUND2_COLOR);
