...
SciCalc::SciCalc() {
  { win = new Fl_Double_Window(241, 497, "flCalc");
    ...
    { but_quit = new Fl_Button(5, 45, 50, 35, "Exit");
      but_quit->tooltip("Quit the program");
    ...
    { box_DEGRAD = new StaticText(65, 45, 35, 35);
      box_DEGRAD->tooltip("Degree, Radian, Gradian");
    ...
    { check_inv = new Fl_Button(5, 85, 35, 35, "inv");
      check_inv->type(1);
    ...
    { Fl_Group* o = new Fl_Group(65, 83, 170, 42);
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)36);
      { radio_2 = new Fl_Button(70, 86, 35, 35, "2");
        radio_2->tooltip("Base 2");
        radio_2->type(102);
      ...
      { radio_8 = new Fl_Button(111, 86, 35, 35, "8");
        radio_8->tooltip("Base 8");
        radio_8->type(102);
      ...
      { radio_10 = new Fl_Button(153, 86, 35, 35, "10");
        radio_10->tooltip("Base 10 (default)");
        radio_10->type(102);
      ...
      { radio_16 = new Fl_Button(195, 86, 35, 35, "16");
        radio_16->tooltip("Base");
        radio_16->type(102);
    ...
    { Fl_Group* o = new Fl_Group(5, 125, 230, 135);
      o->box(FL_FLAT_BOX);
      o->color(FL_DARK1);
      { but_sqrt = new Fl_Button(10, 130, 35, 35, "\342\210\232");
        but_sqrt->tooltip("Square root");
      ...
      { but_pow = new Fl_Button(56, 130, 35, 35, "x^y");
        but_pow->tooltip("Raises X to the power of Y");
      ...
      { but_sin = new Fl_Button(102, 130, 35, 35, "sin");
        but_sin->tooltip("Sine of an angle");
      ...
      { but_cos = new Fl_Button(148, 130, 35, 35, "cos");
        but_cos->tooltip("Cosine of an angle");
      ...
      { but_tan = new Fl_Button(194, 130, 35, 35, "tan");
        but_tan->tooltip("Tangent of an angle");
      ...
      { but_log = new Fl_Button(10, 175, 35, 35, "log");
        but_log->tooltip("Common logarithm");
      ...
      { but_ln = new Fl_Button(56, 175, 35, 35, "ln");
        but_ln->tooltip("Natural logarithm (to the base e)");
      ...
      { but_int = new Fl_Button(102, 175, 35, 35, "int");
      ...
      { but_dr = new Fl_Button(148, 175, 35, 35, "d->r");
      ...
      { but_drg = new Fl_Button(194, 175, 35, 35, "d-r-g");
        but_drg->tooltip("Change the mode of the calculator to accommodate for different measurement of\
 angles- Radians, Degrees and Gradian(Grads)");
      ...
      { but_leftbr = new Fl_Button(10, 219, 35, 35, "[");
      ...
      { but_rightbr = new Fl_Button(56, 219, 35, 35, "]");
    ...
    { Fl_Group* o = new Fl_Group(5, 265, 230, 45);
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)17);
      { but_Mplus = new Fl_Button(10, 270, 35, 35, "M+");
        but_Mplus->tooltip("Add the number on the display to the memory, and store the result in memory");
      ...
      { but_Mmult = new Fl_Button(56, 269, 35, 35, "M*");
        but_Mmult->tooltip("Multiply the number on the display to the memory, and store the result in mem\
ory");
      ...
      { but_Mclear = new Fl_Button(102, 269, 35, 35, "MC");
        but_Mclear->tooltip("Erase the memory content");
      ...
      { but_Mst = new Fl_Button(148, 269, 35, 35, "Mst");
        but_Mst->tooltip("Put the number on the display into the memory to save.");
      ...
      { but_Mrc = new Fl_Button(195, 269, 35, 35, "Mrc");
        but_Mrc->tooltip("Recall the number in memory");
    ...
    { Fl_Group* o = new Fl_Group(5, 314, 140, 176);
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)43);
      { but_7 = new Fl_Button(15, 321, 35, 35, "7");
      ...
      { but_8 = new Fl_Button(57, 321, 35, 35, "8");
      ...
      { but_9 = new Fl_Button(97, 321, 35, 35, "9");
      ...
      { but_4 = new Fl_Button(15, 362, 35, 35, "4");
      ...
      { but_5 = new Fl_Button(57, 362, 35, 35, "5");
      ...
      { but_6 = new Fl_Button(97, 362, 35, 35, "6");
      ...
      { but_1 = new Fl_Button(15, 404, 35, 35, "1");
      ...
      { but_2 = new Fl_Button(57, 404, 35, 35, "2");
      ...
      { but_3 = new Fl_Button(97, 404, 35, 35, "3");
      ...
      { but_0 = new Fl_Button(15, 446, 35, 35, "0");
      ...
      { but_dot = new Fl_Button(57, 446, 35, 35, ".");
      ...
      { but_sign = new Fl_Button(97, 446, 35, 35, "+/-");
        but_sign->tooltip("Changes the mathematical sign of the displayed number to the opposite one");
    ...
    { Fl_Group* o = new Fl_Group(150, 315, 85, 175);
      o->box(FL_FLAT_BOX);
      o->color(FL_DARK1);
      { but_C = new Fl_Button(155, 321, 35, 35, "C");
        but_C->tooltip("Resets the calculator without resetting the memory");
      ...
      { but_AC = new Fl_Button(195, 321, 35, 35, "AC");
        but_AC->tooltip("Reset the calculator and reset the memory");
      ...
      { but_X = new Fl_Button(155, 362, 35, 35, "x");
        but_X->tooltip("Multiply");
      ...
      { but_div = new Fl_Button(194, 362, 35, 35, "/");
        but_div->tooltip("Divide");
      ...
      { but_plus = new Fl_Button(155, 404, 35, 35, "+");
        but_plus->tooltip("Add");
      ...
      { but_minus = new Fl_Button(194, 404, 35, 35, "-");
        but_minus->tooltip("Subtract");
      ...
      { but_pi = new Fl_Button(155, 446, 35, 35, "e/p");
        but_pi->tooltip("\316\240");
      ...
      { but_eval = new Fl_Button(194, 446, 35, 35, "=");
        but_eval->tooltip("Equal");
