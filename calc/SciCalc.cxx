...
#include <stdio.h>
#include "math.h"
//extern "C" char *strcat(const char *,char *);
...
void SciCalc::cb_leddisplay_i(StaticText* o, void*) {
  o->value("0 ");
}
void SciCalc::cb_leddisplay(StaticText* o, void* v) {
...
void SciCalc::cb_box_DEGRAD_i(StaticText* o, void*) {
  o->value(" ");
}
void SciCalc::cb_box_DEGRAD(StaticText* o, void* v) {
  ((SciCalc*)(o->parent()->user_data()))->cb_box_DEGRAD_i(o,v);
}

void SciCalc::cb_box_M_i(StaticText* o, void*) {
  o->value("M");
}
void SciCalc::cb_box_M(StaticText* o, void* v) {
...
void SciCalc::cb_but_sqrt(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_sqrt_i(o,v);
}
...
void SciCalc::cb_but_pow(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_pow_i(o,v);
}
...
void SciCalc::cb_but_sin(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_sin_i(o,v);
}
...
void SciCalc::cb_but_cos(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_cos_i(o,v);
}
...
void SciCalc::cb_but_tan(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_tan_i(o,v);
}
...
void SciCalc::cb_but_log(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_log_i(o,v);
}
...
void SciCalc::cb_but_ln(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_ln_i(o,v);
}
...
void SciCalc::cb_but_int(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_int_i(o,v);
}
...
void SciCalc::cb_but_dr(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_dr_i(o,v);
}
...
void SciCalc::cb_but_drg(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_drg_i(o,v);
}
...
void SciCalc::cb_but_leftbr(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_leftbr_i(o,v);
}
...
void SciCalc::cb_but_rightbr(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_rightbr_i(o,v);
}
...
void SciCalc::cb_but_exch(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_exch_i(o,v);
}
...
void SciCalc::cb_but_invx(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_invx_i(o,v);
}
...
void SciCalc::cb_but_fact(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_fact_i(o,v);
}
...
void SciCalc::cb_but_Mplus(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_Mplus_i(o,v);
}
...
void SciCalc::cb_but_Mmult(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_Mmult_i(o,v);
}
...
void SciCalc::cb_but_Mclear(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_Mclear_i(o,v);
}
...
void SciCalc::cb_but_Mst(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_Mst_i(o,v);
}
...
void SciCalc::cb_but_Mrc(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_Mrc_i(o,v);
}
...
void SciCalc::cb_but_C(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_C_i(o,v);
}
...
void SciCalc::cb_but_AC(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_AC_i(o,v);
}
...
void SciCalc::cb_but_X(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_X_i(o,v);
}
...
void SciCalc::cb_but_div(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_div_i(o,v);
}
...
void SciCalc::cb_but_plus(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_plus_i(o,v);
}
...
void SciCalc::cb_but_minus(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_minus_i(o,v);
}
...
void SciCalc::cb_but_pi(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_pi_i(o,v);
}
...
void SciCalc::cb_but_eval(Fl_Button* o, void* v) {
  ((SciCalc*)(o->parent()->parent()->user_data()))->cb_but_eval_i(o,v);
}
...
SciCalc::SciCalc() {
  { win = new Fl_Double_Window(241, 497, gettext("flCalc"));
    win->user_data((void*)(this));
    { leddisplay = new StaticText(5, 7, 230, 33);
      leddisplay->box(FL_FLAT_BOX);
      leddisplay->color((Fl_Color)207);
      leddisplay->selection_color(FL_BACKGROUND_COLOR);
      leddisplay->labeltype(FL_NORMAL_LABEL);
      leddisplay->labelfont(1);
      leddisplay->labelsize(16);
      leddisplay->labelcolor((Fl_Color)59);
      leddisplay->callback((Fl_Callback*)cb_leddisplay);
      leddisplay->align(Fl_Align(FL_ALIGN_RIGHT|FL_ALIGN_INSIDE));
      leddisplay->when(FL_WHEN_RELEASE);
    } // StaticText* leddisplay
    { but_quit = new Fl_Button(5, 45, 50, 35, gettext("Exit"));
      but_quit->tooltip(gettext("Quit the program"));
      but_quit->box(FL_FLAT_BOX);
      but_quit->color((Fl_Color)80);
      but_quit->labelfont(1);
      but_quit->labelsize(12);
      but_quit->labelcolor(FL_BACKGROUND2_COLOR);
      but_quit->callback((Fl_Callback*)cb_but_quit);
    } // Fl_Button* but_quit
    { box_DEGRAD = new StaticText(65, 45, 35, 35);
      box_DEGRAD->tooltip(gettext("Degree, Radian, Gradian"));
      box_DEGRAD->box(FL_FLAT_BOX);
      box_DEGRAD->color(FL_DARK3);
      box_DEGRAD->selection_color(FL_BACKGROUND_COLOR);
      box_DEGRAD->labeltype(FL_NORMAL_LABEL);
      box_DEGRAD->labelfont(0);
      box_DEGRAD->labelsize(9);
      box_DEGRAD->labelcolor(FL_BACKGROUND2_COLOR);
      box_DEGRAD->callback((Fl_Callback*)cb_box_DEGRAD);
      box_DEGRAD->align(Fl_Align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE));
      box_DEGRAD->when(FL_WHEN_RELEASE);
    } // StaticText* box_DEGRAD
    { box_bracket = new StaticText(104, 45, 91, 35);
      box_bracket->box(FL_FLAT_BOX);
      box_bracket->color((Fl_Color)38);
      box_bracket->selection_color(FL_BACKGROUND_COLOR);
      box_bracket->labeltype(FL_NORMAL_LABEL);
      box_bracket->labelfont(0);
      box_bracket->labelsize(9);
      box_bracket->labelcolor(FL_BACKGROUND2_COLOR);
      box_bracket->align(Fl_Align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE));
      box_bracket->when(FL_WHEN_RELEASE);
    } // StaticText* box_bracket
    { box_M = new StaticText(200, 45, 35, 35);
      box_M->tooltip(gettext("Memory"));
      box_M->box(FL_FLAT_BOX);
      box_M->color((Fl_Color)38);
      box_M->selection_color(FL_BACKGROUND_COLOR);
      box_M->labeltype(FL_NORMAL_LABEL);
      box_M->labelfont(0);
      box_M->labelsize(9);
      box_M->labelcolor(FL_BACKGROUND2_COLOR);
      box_M->callback((Fl_Callback*)cb_box_M);
      box_M->align(Fl_Align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE));
      box_M->when(FL_WHEN_RELEASE);
    } // StaticText* box_M
    { check_inv = new Fl_Button(5, 85, 35, 35, gettext("inv"));
      check_inv->type(1);
      check_inv->box(FL_FLAT_BOX);
      check_inv->color((Fl_Color)51);
      check_inv->labelsize(11);
      check_inv->labelcolor((Fl_Color)4);
      check_inv->callback((Fl_Callback*)cb_check_inv);
    } // Fl_Button* check_inv
    { Fl_Group* o = new Fl_Group(65, 83, 170, 42);
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)36);
      { radio_2 = new Fl_Button(70, 86, 35, 35, gettext("2"));
        radio_2->tooltip(gettext("Base 2"));
        radio_2->type(102);
        radio_2->box(FL_FLAT_BOX);
        radio_2->selection_color((Fl_Color)40);
        radio_2->labelfont(1);
        radio_2->labelsize(12);
        radio_2->labelcolor((Fl_Color)1);
        radio_2->callback((Fl_Callback*)cb_radio_2);
      } // Fl_Button* radio_2
      { radio_8 = new Fl_Button(111, 86, 35, 35, gettext("8"));
        radio_8->tooltip(gettext("Base 8"));
        radio_8->type(102);
        radio_8->box(FL_FLAT_BOX);
        radio_8->selection_color((Fl_Color)40);
        radio_8->labelfont(1);
        radio_8->labelsize(12);
        radio_8->labelcolor((Fl_Color)1);
        radio_8->callback((Fl_Callback*)cb_radio_8);
      } // Fl_Button* radio_8
      { radio_10 = new Fl_Button(153, 86, 35, 35, gettext("10"));
        radio_10->tooltip(gettext("Base 10 (default)"));
        radio_10->type(102);
        radio_10->box(FL_FLAT_BOX);
        radio_10->value(1);
        radio_10->selection_color((Fl_Color)40);
        radio_10->labelfont(1);
        radio_10->labelsize(12);
        radio_10->labelcolor((Fl_Color)1);
        radio_10->callback((Fl_Callback*)cb_radio_10);
      } // Fl_Button* radio_10
      { radio_16 = new Fl_Button(195, 86, 35, 35, gettext("16"));
        radio_16->tooltip(gettext("Base"));
        radio_16->type(102);
        radio_16->box(FL_FLAT_BOX);
        radio_16->selection_color((Fl_Color)40);
        radio_16->labelfont(1);
        radio_16->labelsize(12);
        radio_16->labelcolor((Fl_Color)1);
        radio_16->callback((Fl_Callback*)cb_radio_16);
      } // Fl_Button* radio_16
      o->end();
    } // Fl_Group* o
    { Fl_Group* o = new Fl_Group(5, 125, 230, 135);
      o->box(FL_FLAT_BOX);
      o->color(FL_DARK1);
      { Fl_Button* o = but_sqrt = new Fl_Button(10, 130, 35, 35);
        but_sqrt->tooltip(gettext("Square root"));
        but_sqrt->box(FL_FLAT_BOX);
        but_sqrt->color((Fl_Color)17);
        but_sqrt->labelsize(11);
        but_sqrt->labelcolor((Fl_Color)4);
        but_sqrt->callback((Fl_Callback*)cb_but_sqrt);
        o->copy_label("√");//avoid localization
      } // Fl_Button* but_sqrt
      { but_pow = new Fl_Button(56, 130, 35, 35, gettext("x^y"));
        but_pow->tooltip(gettext("Raises X to the power of Y"));
        but_pow->box(FL_FLAT_BOX);
        but_pow->color((Fl_Color)17);
        but_pow->labelsize(11);
        but_pow->labelcolor((Fl_Color)4);
        but_pow->callback((Fl_Callback*)cb_but_pow);
      } // Fl_Button* but_pow
      { but_sin = new Fl_Button(102, 130, 35, 35, gettext("sin"));
        but_sin->tooltip(gettext("Sine of an angle"));
        but_sin->box(FL_FLAT_BOX);
        but_sin->color((Fl_Color)17);
        but_sin->labelsize(11);
        but_sin->labelcolor((Fl_Color)4);
        but_sin->callback((Fl_Callback*)cb_but_sin);
      } // Fl_Button* but_sin
      { but_cos = new Fl_Button(148, 130, 35, 35, gettext("cos"));
        but_cos->tooltip(gettext("Cosine of an angle"));
        but_cos->box(FL_FLAT_BOX);
        but_cos->color((Fl_Color)17);
        but_cos->labelsize(11);
        but_cos->labelcolor((Fl_Color)4);
        but_cos->callback((Fl_Callback*)cb_but_cos);
      } // Fl_Button* but_cos
      { but_tan = new Fl_Button(194, 130, 35, 35, gettext("tan"));
        but_tan->tooltip(gettext("Tangent of an angle"));
        but_tan->box(FL_FLAT_BOX);
        but_tan->color((Fl_Color)17);
        but_tan->labelsize(11);
        but_tan->labelcolor((Fl_Color)4);
        but_tan->callback((Fl_Callback*)cb_but_tan);
      } // Fl_Button* but_tan
      { but_log = new Fl_Button(10, 175, 35, 35, gettext("log"));
        but_log->tooltip(gettext("Common logarithm"));
        but_log->box(FL_FLAT_BOX);
        but_log->color((Fl_Color)17);
        but_log->labelsize(11);
        but_log->labelcolor((Fl_Color)4);
        but_log->callback((Fl_Callback*)cb_but_log);
      } // Fl_Button* but_log
      { but_ln = new Fl_Button(56, 175, 35, 35, gettext("ln"));
        but_ln->tooltip(gettext("Natural logarithm (to the base e)"));
        but_ln->box(FL_FLAT_BOX);
        but_ln->color((Fl_Color)17);
        but_ln->labelsize(11);
        but_ln->labelcolor((Fl_Color)4);
        but_ln->callback((Fl_Callback*)cb_but_ln);
      } // Fl_Button* but_ln
      { but_int = new Fl_Button(102, 175, 35, 35, gettext("int"));
        but_int->box(FL_FLAT_BOX);
        but_int->color((Fl_Color)17);
        but_int->labelsize(11);
        but_int->labelcolor((Fl_Color)4);
        but_int->callback((Fl_Callback*)cb_but_int);
      } // Fl_Button* but_int
      { but_dr = new Fl_Button(148, 175, 35, 35, gettext("d->r"));
        but_dr->box(FL_FLAT_BOX);
        but_dr->color((Fl_Color)17);
        but_dr->labelsize(10);
        but_dr->labelcolor((Fl_Color)4);
        but_dr->callback((Fl_Callback*)cb_but_dr);
      } // Fl_Button* but_dr
      { but_drg = new Fl_Button(194, 175, 35, 35, gettext("d-r-g"));
        but_drg->tooltip(gettext("Change the mode of the calculator to accommodate for different measurement of\
 angles- Radians, Degrees and Gradian(Grads)"));
        but_drg->box(FL_FLAT_BOX);
        but_drg->color((Fl_Color)17);
        but_drg->labelsize(9);
        but_drg->callback((Fl_Callback*)cb_but_drg);
      } // Fl_Button* but_drg
      { but_leftbr = new Fl_Button(10, 219, 35, 35, gettext("["));
        but_leftbr->box(FL_FLAT_BOX);
        but_leftbr->shortcut(0x28);
        but_leftbr->color((Fl_Color)17);
        but_leftbr->labelsize(11);
        but_leftbr->callback((Fl_Callback*)cb_but_leftbr);
      } // Fl_Button* but_leftbr
      { but_rightbr = new Fl_Button(56, 219, 35, 35, gettext("]"));
        but_rightbr->box(FL_FLAT_BOX);
        but_rightbr->shortcut(0x29);
        but_rightbr->color((Fl_Color)17);
        but_rightbr->labelsize(11);
        but_rightbr->callback((Fl_Callback*)cb_but_rightbr);
      } // Fl_Button* but_rightbr
      { but_exch = new Fl_Button(102, 219, 35, 35, gettext("exch"));
        but_exch->box(FL_FLAT_BOX);
        but_exch->color((Fl_Color)17);
        but_exch->labelsize(11);
        but_exch->callback((Fl_Callback*)cb_but_exch);
      } // Fl_Button* but_exch
      { but_invx = new Fl_Button(148, 219, 35, 35, gettext("1/x"));
        but_invx->box(FL_FLAT_BOX);
        but_invx->color((Fl_Color)17);
        but_invx->labelsize(11);
        but_invx->callback((Fl_Callback*)cb_but_invx);
      } // Fl_Button* but_invx
      { but_fact = new Fl_Button(194, 219, 35, 35, gettext("x!"));
        but_fact->box(FL_FLAT_BOX);
        but_fact->color((Fl_Color)17);
        but_fact->labelsize(11);
        but_fact->callback((Fl_Callback*)cb_but_fact);
      } // Fl_Button* but_fact
      o->end();
    } // Fl_Group* o
    { Fl_Group* o = new Fl_Group(5, 265, 230, 45);
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)17);
      { but_Mplus = new Fl_Button(10, 270, 35, 35, gettext("M+"));
        but_Mplus->tooltip(gettext("Add the number on the display to the memory, and store the result in memory"));
        but_Mplus->box(FL_FLAT_BOX);
        but_Mplus->color((Fl_Color)93);
        but_Mplus->labelfont(1);
        but_Mplus->labelsize(12);
        but_Mplus->labelcolor((Fl_Color)4);
        but_Mplus->callback((Fl_Callback*)cb_but_Mplus);
      } // Fl_Button* but_Mplus
      { but_Mmult = new Fl_Button(56, 269, 35, 35, gettext("M*"));
        but_Mmult->tooltip(gettext("Multiply the number on the display to the memory, and store the result in mem\
ory"));
        but_Mmult->box(FL_FLAT_BOX);
        but_Mmult->color((Fl_Color)93);
        but_Mmult->labelfont(1);
        but_Mmult->labelsize(12);
        but_Mmult->labelcolor((Fl_Color)4);
        but_Mmult->callback((Fl_Callback*)cb_but_Mmult);
      } // Fl_Button* but_Mmult
      { but_Mclear = new Fl_Button(102, 269, 35, 35, gettext("MC"));
        but_Mclear->tooltip(gettext("Erase the memory content"));
        but_Mclear->box(FL_FLAT_BOX);
        but_Mclear->color((Fl_Color)93);
        but_Mclear->labelfont(1);
        but_Mclear->labelsize(12);
        but_Mclear->labelcolor((Fl_Color)4);
        but_Mclear->callback((Fl_Callback*)cb_but_Mclear);
      } // Fl_Button* but_Mclear
      { but_Mst = new Fl_Button(148, 269, 35, 35, gettext("Mst"));
        but_Mst->tooltip(gettext("Put the number on the display into the memory to save."));
        but_Mst->box(FL_FLAT_BOX);
        but_Mst->color((Fl_Color)93);
        but_Mst->labelfont(1);
        but_Mst->labelsize(12);
        but_Mst->callback((Fl_Callback*)cb_but_Mst);
      } // Fl_Button* but_Mst
      { but_Mrc = new Fl_Button(195, 269, 35, 35, gettext("Mrc"));
        but_Mrc->tooltip(gettext("Recall the number in memory"));
        but_Mrc->box(FL_FLAT_BOX);
        but_Mrc->color((Fl_Color)93);
        but_Mrc->labelfont(1);
        but_Mrc->labelsize(12);
        but_Mrc->callback((Fl_Callback*)cb_but_Mrc);
      } // Fl_Button* but_Mrc
      o->end();
    } // Fl_Group* o
    { Fl_Group* o = new Fl_Group(5, 314, 140, 176);
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)43);
      { but_7 = new Fl_Button(15, 321, 35, 35, gettext("7"));
        but_7->box(FL_FLAT_BOX);
        but_7->shortcut(0x37);
        but_7->color((Fl_Color)23);
        but_7->labelfont(1);
        but_7->labelsize(16);
        but_7->callback((Fl_Callback*)cb_but_7);
      } // Fl_Button* but_7
      { but_8 = new Fl_Button(57, 321, 35, 35, gettext("8"));
        but_8->box(FL_FLAT_BOX);
        but_8->shortcut(0x38);
        but_8->color((Fl_Color)23);
        but_8->labelfont(1);
        but_8->labelsize(16);
        but_8->callback((Fl_Callback*)cb_but_8);
      } // Fl_Button* but_8
      { but_9 = new Fl_Button(97, 321, 35, 35, gettext("9"));
        but_9->box(FL_FLAT_BOX);
        but_9->shortcut(0x39);
        but_9->color((Fl_Color)23);
        but_9->labelfont(1);
        but_9->labelsize(16);
        but_9->callback((Fl_Callback*)cb_but_9);
      } // Fl_Button* but_9
      { but_4 = new Fl_Button(15, 362, 35, 35, gettext("4"));
        but_4->box(FL_FLAT_BOX);
        but_4->shortcut(0x34);
        but_4->color((Fl_Color)23);
        but_4->labelfont(1);
        but_4->labelsize(16);
        but_4->callback((Fl_Callback*)cb_but_4);
      } // Fl_Button* but_4
      { but_5 = new Fl_Button(57, 362, 35, 35, gettext("5"));
        but_5->box(FL_FLAT_BOX);
        but_5->shortcut(0x35);
        but_5->color((Fl_Color)23);
        but_5->labelfont(1);
        but_5->labelsize(16);
        but_5->callback((Fl_Callback*)cb_but_5);
      } // Fl_Button* but_5
      { but_6 = new Fl_Button(97, 362, 35, 35, gettext("6"));
        but_6->box(FL_FLAT_BOX);
        but_6->shortcut(0x36);
        but_6->color((Fl_Color)23);
        but_6->labelfont(1);
        but_6->labelsize(16);
        but_6->callback((Fl_Callback*)cb_but_6);
      } // Fl_Button* but_6
      { but_1 = new Fl_Button(15, 404, 35, 35, gettext("1"));
        but_1->box(FL_FLAT_BOX);
        but_1->shortcut(0x31);
        but_1->color((Fl_Color)23);
        but_1->labelfont(1);
        but_1->labelsize(16);
        but_1->callback((Fl_Callback*)cb_but_1);
      } // Fl_Button* but_1
      { but_2 = new Fl_Button(57, 404, 35, 35, gettext("2"));
        but_2->box(FL_FLAT_BOX);
        but_2->shortcut(0x32);
        but_2->color((Fl_Color)23);
        but_2->labelfont(1);
        but_2->labelsize(16);
        but_2->callback((Fl_Callback*)cb_but_2);
      } // Fl_Button* but_2
      { but_3 = new Fl_Button(97, 404, 35, 35, gettext("3"));
        but_3->box(FL_FLAT_BOX);
        but_3->shortcut(0x33);
        but_3->color((Fl_Color)23);
        but_3->labelfont(1);
        but_3->labelsize(16);
        but_3->callback((Fl_Callback*)cb_but_3);
      } // Fl_Button* but_3
      { but_0 = new Fl_Button(15, 446, 35, 35, gettext("0"));
        but_0->box(FL_FLAT_BOX);
        but_0->shortcut(0x30);
        but_0->color((Fl_Color)23);
        but_0->labelfont(1);
        but_0->labelsize(16);
        but_0->callback((Fl_Callback*)cb_but_0);
      } // Fl_Button* but_0
      { but_dot = new Fl_Button(57, 446, 35, 35, gettext("."));
        but_dot->box(FL_FLAT_BOX);
        but_dot->shortcut(0x2e);
        but_dot->color((Fl_Color)23);
        but_dot->labelfont(1);
        but_dot->labelsize(16);
        but_dot->callback((Fl_Callback*)cb_but_dot);
      } // Fl_Button* but_dot
      { but_sign = new Fl_Button(97, 446, 35, 35, gettext("+/-"));
        but_sign->tooltip(gettext("Changes the mathematical sign of the displayed number to the opposite one"));
        but_sign->box(FL_FLAT_BOX);
        but_sign->color((Fl_Color)23);
    ...
    { Fl_Group* o = new Fl_Group(150, 315, 85, 175);
      o->box(FL_FLAT_BOX);
      o->color(FL_DARK1);
      { but_C = new Fl_Button(155, 321, 35, 35, gettext("C"));
        but_C->tooltip(gettext("Resets the calculator without resetting the memory"));
        but_C->box(FL_FLAT_BOX);
        but_C->shortcut(0xff08);
        but_C->color((Fl_Color)80);
        but_C->labelfont(1);
        but_C->labelsize(16);
        but_C->labelcolor(FL_BACKGROUND2_COLOR);
        but_C->callback((Fl_Callback*)cb_but_C);
      } // Fl_Button* but_C
      { but_AC = new Fl_Button(195, 321, 35, 35, gettext("AC"));
        but_AC->tooltip(gettext("Reset the calculator and reset the memory"));
        but_AC->box(FL_FLAT_BOX);
        but_AC->shortcut(0xffff);
        but_AC->color((Fl_Color)80);
        but_AC->labelfont(1);
        but_AC->labelsize(16);
        but_AC->labelcolor(FL_BACKGROUND2_COLOR);
        but_AC->callback((Fl_Callback*)cb_but_AC);
      } // Fl_Button* but_AC
      { but_X = new Fl_Button(155, 362, 35, 35, gettext("x"));
        but_X->tooltip(gettext("Multiply"));
        but_X->box(FL_FLAT_BOX);
        but_X->shortcut(0x2a);
        but_X->color((Fl_Color)190);
        but_X->selection_color((Fl_Color)221);
        but_X->labelfont(1);
        but_X->labelsize(16);
        but_X->callback((Fl_Callback*)cb_but_X);
      } // Fl_Button* but_X
      { but_div = new Fl_Button(194, 362, 35, 35, gettext("/"));
        but_div->tooltip(gettext("Divide"));
        but_div->box(FL_FLAT_BOX);
        but_div->shortcut(0x2f);
        but_div->color((Fl_Color)190);
        but_div->selection_color((Fl_Color)221);
        but_div->labelfont(1);
        but_div->labelsize(16);
        but_div->callback((Fl_Callback*)cb_but_div);
      } // Fl_Button* but_div
      { but_plus = new Fl_Button(155, 404, 35, 35, gettext("+"));
        but_plus->tooltip(gettext("Add"));
        but_plus->box(FL_FLAT_BOX);
        but_plus->shortcut(0x2b);
        but_plus->color((Fl_Color)190);
        but_plus->selection_color((Fl_Color)221);
        but_plus->labelfont(1);
        but_plus->labelsize(16);
        but_plus->callback((Fl_Callback*)cb_but_plus);
      } // Fl_Button* but_plus
      { but_minus = new Fl_Button(194, 404, 35, 35, gettext("-"));
        but_minus->tooltip(gettext("Subtract"));
        but_minus->box(FL_FLAT_BOX);
        but_minus->shortcut(0x2d);
        but_minus->color((Fl_Color)190);
        but_minus->selection_color((Fl_Color)221);
        but_minus->labelfont(1);
        but_minus->labelsize(16);
        but_minus->callback((Fl_Callback*)cb_but_minus);
      } // Fl_Button* but_minus
      { Fl_Button* o = but_pi = new Fl_Button(155, 446, 35, 35);
        but_pi->tooltip(gettext("Pi"));
        but_pi->box(FL_FLAT_BOX);
        but_pi->color((Fl_Color)190);
        but_pi->selection_color((Fl_Color)221);
        but_pi->labelfont(12);
        but_pi->labelsize(17);
        but_pi->callback((Fl_Callback*)cb_but_pi);
        o->copy_label("e/Π");//avoid localization
      } // Fl_Button* but_pi
      { but_eval = new Fl_Button(194, 446, 35, 35, gettext("="));
        but_eval->tooltip(gettext("Equal"));
        but_eval->box(FL_FLAT_BOX);
        but_eval->shortcut(0xff0d);
        but_eval->color((Fl_Color)190);
        but_eval->selection_color((Fl_Color)221);
    ...
    { but_eval_hidden = new Fl_Button(150, 483, 6, 7);
    ...
    { but_eval_hidden2 = new Fl_Button(175, 488, 6, 7);
...
void SciCalc::make_icon(Fl_Window *o) {
  Fl_Pixmap f(flcalc_xpm);
