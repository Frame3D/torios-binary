...
Fl_Double_Window* UI::make_window() {
  { screener_win = new Fl_Double_Window(170, 80, "Screenie");
    screener_win->user_data((void*)(this));
    { Fl_Button* o = new Fl_Button(5, 40, 90, 35, "Full Screen");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)61);
    ...
    { Fl_Button* o = new Fl_Button(100, 40, 65, 35, "Quit");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
    ...
    { new Fl_Box(5, 5, 155, 35, "Take a Screen shot");
    } // Fl_Box* o
    { Fl_Button* o = new Fl_Button(5, 80, 90, 35, "Area");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)61);
      o->selection_color(FL_DARK_GREEN);
      o->labelcolor(FL_BACKGROUND2_COLOR);
...
Fl_Double_Window* UI::sizer_window() {
  { s_win = new Fl_Double_Window(255, 185);
    ...
    { Fl_Button* o = new Fl_Button(55, 75, 145, 40, "Take Screen Shot");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)62);
      o->labelcolor(FL_BACKGROUND2_COLOR);
...
Fl_Double_Window* Screenie::preview_image() {
  { previewer_win = new Fl_Double_Window(445, 390, "Preview");
    ...
    { saver = new Fl_Button(290, 340, 70, 35, "Save");
    ...
    { Fl_Button* o = new Fl_Button(370, 340, 70, 35, "Quit");
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)80);
      o->selection_color(FL_DARK_RED);
      o->labelcolor(FL_BACKGROUND2_COLOR);
